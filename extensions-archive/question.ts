/**
 * Question 工具 - 让 AI 主动向你提问
 *
 * 借鉴自 https://github.com/bd-dxg/my-pi (MIT)
 * AI 拿不定主意时，弹选项让你选（支持"自己输入"）。
 * 与 questionnaire.ts 的区别：本工具单题轻量版。
 */
...
const QuestionParams = Type.Object({
	...
	options: Type.Array(OptionSchema, { description: "选项列表（2-5 个）" }),
});
